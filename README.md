...
The goal is to understand the trade-off between **interpretability** and **performance** when learning policies from trajectories generated by a recurrent RL expert.
